...
@synthesize lectureNo, webview, lectureTitle;
...
- (void)viewDidLoad
{
    ...
    self.navigationItem.title = [NSString stringWithFormat:@"%@ 강의계획서", lectureTitle];
    ...
    NSString *urlString = [NSString stringWithFormat:@"%@/eClassRoom/lectureScheduleInfo.do?LecNo=%d", kServerUrl, lectureNo];
